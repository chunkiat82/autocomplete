...
var WordsFilter = (function () {
    function WordsFilter(list) {
        _classCallCheck(this, WordsFilter);
    ...
    _createClass(WordsFilter, [{
        key: 'calculateState',
        value: function calculateState(input) {
        ...
        value: function filter(input) {
            ...
            return this.currentList = this.currentList.filter(function (element) {
                return element.toLowerCase().indexOf(input) > -1;
            });
        }
    }]);
